...
For a depth three tree it is $O(p^3 n^2 (log n + d))$. If a depth two tree with 1000 observations, 4 features and 3 actions took around 0.18 seconds, you can
expect the level three tree to take approximately $1000\cdot 4$ times as long ($\approx
\frac{p^3n^2}{p^2n}=pn$)
