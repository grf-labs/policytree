...
This document provides a short introduction to the `policytree` package, with examples from Zhou, Athey and Wager (2018), and Wager and Athey (2017). The last section addresses details, such as treatment estimates with one-vs-all grf, and the runtime of `policy_tree`.
